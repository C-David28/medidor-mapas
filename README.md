...
Para instalación en Windows, pruebas y despliegue en Render, consulta
[la guía en español](DEPLOY_RENDER.md). Incluye restricciones de la clave y la
configuración final. El modo Radio usa la API Circle: selecciona un radio y el
centro, o pulsa Dibujar y marca el centro y el borde con dos clics.
